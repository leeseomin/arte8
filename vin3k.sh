...
# 4k 크기의 하얀 배경 이미지 생성
convert -size 3000x3000 canvas:white -colorspace RGB white_background.png

# 3000x3000 크기의 이미지를 4k 하얀 배경의 중앙에 배치
parallel convert {} -gravity center -background white -extent 3000x3000 {/.}_centered.png ::: *.png
